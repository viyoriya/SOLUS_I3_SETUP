...
static const char *fonts[]          = { "monospace:style=regular:size=10" };
...
/*	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } }, */
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY,       				XK_0,      spawn,          SHCMD("~/.dwm/power-menu.sh") },
	{ MODKEY,       				XK_Print,  spawn,          SHCMD("~/.dwm/screenshot.sh") },
	{ MODKEY|ShiftMask,       		XK_Print,  spawn,          SHCMD("~/.dwm/screenshot-w.sh") },
